...
public class ChatMessageRetreive extends RecyclerView.Adapter<ChatMessageRetreive.ViewHolder> {
    ...
    private List<SendAndReceiveMessage> mchat;
    private String imageurl;
    public static final int MSG_TYPE_LEFT= 0;
    public static final int MSG_TYPE_RIGHT= 1;
    FirebaseUser fuser;

    public ChatMessageRetreive(Context mContext, List<SendAndReceiveMessage> mchat, String imageurl) {
        this.mchat = mchat;
    ...
    public void onBindViewHolder(@NonNull ChatMessageRetreive.ViewHolder holder2, int position) {
        ...
        SendAndReceiveMessage chat = mchat.get(position);
